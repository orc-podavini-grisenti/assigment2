...
Path Tracking with Cyclic Terminal Cost 
...
def run_q2(visualize=True, plot_results=True):
    ...
    # OCP Formulation
    ocp = cyclic_path_tracking(opti, X, U, S, W, N, dt,
                               robot_setup.x_init,
                               robot_setup.c_path,
                               robot_setup.r_path,
                               w_v, w_a, w_w, w_final,
...
def cyclic_path_tracking(opti, X, U, S, W, N, dt, x_init,
    ...
    Args:
        ...
        w_final: Weight of the cyclic terminal cost
        nq: Number of Joints
